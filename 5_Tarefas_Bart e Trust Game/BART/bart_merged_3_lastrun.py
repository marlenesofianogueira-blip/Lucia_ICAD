...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/marlenenogueira/Documents/Academia/Projects/Lúcia/5_Tarefas_Bart e Trust Game/BART/bart_merged_3_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    welcome = data.Routine(
        name='welcome',
        components=[welcome_2, _fundo_branco_, welcome_, resposta_, smile, text_3],
    )
    ...
    bart_manual = data.Routine(
        name='bart_manual',
        components=[bart_manual_2, fundo_branco],
    )
    ...
    instructions = data.Routine(
        name='instructions',
        components=[instructions_2, fundobranco, balão, euro, balão_rebentado, perder_dinheiro, instruções1, seta_avançar, text_avançar_2, mouse_1],
    )
    ...
    instructions_3 = data.Routine(
        name='instructions_3',
        components=[instructions_4, fundobranco1, enter_tecla, instruções2, encher_balão, guardar_dinheiro, seta_avançar_2, text_avançar, mouse_2],
    )
    ...
    for thisTrial_2 in trials_2:
        ...
        trial_2 = data.Routine(
            name='trial_2',
            components=[trial, fundobranco2, bankButton, balloonBody, molduraRM1, molduraRM2, molduraBVM, molduraBM, reminderMsg1, reminderMsg2, balloonValMsg, bankedMsg],
        )
        ...
        feedback_2 = data.Routine(
            name='feedback_2',
            components=[feedback, fundobranco3, feedbackMsg22],
        )
    ...
    final_score = data.Routine(
        name='final_score',
        components=[final_score_2, fundobranco4, finalScore],
    )
    ...
    farwell = data.Routine(
        name='farwell',
        components=[farwell_2, _fundo_branco_final, farwell_, smile_final],
    )
