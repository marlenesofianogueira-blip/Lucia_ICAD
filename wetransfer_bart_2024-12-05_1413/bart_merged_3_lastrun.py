...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/marlenenogueira/Desktop/Lucia_CAD_project/wetransfer_bart_2024-12-05_1413/bart_merged_3_lastrun.py',
...
# Unknown component ignored: bart_manual_2
...
# Unknown component ignored: instructions_2
...
# Unknown component ignored: instructions_4
...
# Unknown component ignored: trial
...
# Unknown component ignored: feedback
...
# Unknown component ignored: final_score_2
...
# Unknown component ignored: farwell_2
...
welcomeComponents = [welcome_2, _fundo_branco_, welcome_, resposta_, smile, text_3]
...
while continueRoutine:
    ...
    if resposta_.status == STARTED and not waitOnFlip:
        theseKeys = resposta_.getKeys(keyList=['a'], waitRelease=False)
...
# update component parameters for each repeat
# keep track of which components have finished
bart_manualComponents = [bart_manual_2, fundo_branco]
...
for thisComponent in bart_manualComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "bart_manual" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
# keep track of which components have finished
instructionsComponents = [instructions_2, fundobranco, balão, euro, balão_rebentado, perder_dinheiro, instruções1, seta_avançar, text_avançar_2, mouse_1]
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
instructions_3Components = [instructions_4, fundobranco1, enter_tecla, instruções2, encher_balão, guardar_dinheiro, seta_avançar_2, text_avançar, mouse_2]
...
for thisTrial_2 in trials_2:
    ...
    nPumps=0
    # keep track of which components have finished
    trial_2Components = [trial, fundobranco2, bankButton, balloonBody, molduraRM1, molduraRM2, molduraBVM, molduraBM, reminderMsg1, reminderMsg2, balloonValMsg, bankedMsg]
    ...
    # keep track of which components have finished
    feedback_2Components = [feedback, fundobranco3, feedbackMsg22]
...
# keep track of which components have finished
final_scoreComponents = [final_score_2, fundobranco4, finalScore]
...
# update component parameters for each repeat
# keep track of which components have finished
farwellComponents = [farwell_2, _fundo_branco_final, farwell_, smile_final]
...
for thisComponent in farwellComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "farwell" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
